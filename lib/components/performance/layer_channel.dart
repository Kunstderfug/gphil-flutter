...
class LayerChannelLevel extends StatelessWidget {
  ...
  final LayerChannel? layerChannel;
  const LayerChannelLevel(
      {super.key, required this.channelName, this.layerChannel});
        ...
        SizedBox(
          ...
          child: SfSliderTheme(
            ...
            child: SfSlider.vertical(
                ...
                value: layerChannel?.player.playerVolume ?? 0,
                onChanged: (value) => layerChannel != null
                    ? p.setChannelVolume(channelName, value)
                    : null),
          ),
        ),
        Text('${layerChannel?.channelName ?? channelName} '),
      ],
    );
  }
}
