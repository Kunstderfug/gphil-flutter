              ...
              children: [
                SizedBox(
                  ...
                  child: SfSliderTheme(
                    ...
                    child: InkWell(
                      enableFeedback: p.layersEnabled ? false : true,
                      onDoubleTap: p.layersEnabled
                          ? null
                          : () => p.resetSectionVolume(p.currentSection!),
                      child: SfSlider.vertical(
                          ...
                          onChanged: p.layersEnabled
                              ? null
                              : (value) => p.setSectionVolume(section, value)),
                    ),
                  ),
                ),
                InkWell(
